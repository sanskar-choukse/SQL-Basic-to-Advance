...
--or--
select * from Employees where Salary>=60000 and Salary<=70000 and Department like 'Finance'

--5. How do you find employees who work in the 'IT' department and do not have a salary greater than 80,000?
select * from  Employees where Department like 'IT' and Salary<=80000
--or--
...
select * from Employees where (Department like  'IT' and Salary>75000) or Firstname like 'Laura' 
